...
- 2026-06-30: Always use a centralized error-reporting function to funnel unexpected errors instead of calling panic, os.Exit(1) without logging, or Sentry.captureException directly at the call site.
