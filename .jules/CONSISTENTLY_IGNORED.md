...
**- Justification:** Breaks cross-platform compatibility, particularly on Windows. Native tool commands (like `go build -o dist/go-listener-demo ./...` instead of `mkdir -p dist && ...`) must be used instead.
**- Files Affected:** `mise.toml`
